...
export class initialSetup1643695876424 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await this.createUserTable(queryRunner);
    await this.createBookingCompanyTable(queryRunner);
    ...
    await this.createBookingCompanyFK(queryRunner);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE if exists booking_company cascade`);
  ...
  async createBookingCompanyTable(queryRunner: QueryRunner) {
    await queryRunner.createTable(
      new Table({
  ...
  async createBookingCompanyFK(queryRunner: QueryRunner) {
